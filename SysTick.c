...
void SysTick_Wait10ms(uint32_t delay){
  uint32_t i;
  for(i=0; i<delay; i++){
    SysTick_Wait(177776*0.33);  // SysTick(1200000) waits 10ms or 100Hz (assumes 120 MHz clock) 
		// 120(10^6)Hz / 12(10^5) = 100Hz
		//For SysTick(value) : if clock is 17.776MHz then 17.776(10^6)/100Hz = value therefore value = 177776
  }
}
